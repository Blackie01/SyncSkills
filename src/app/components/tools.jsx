...
import { IconBrandSlack, IconBrandTrello, IconBrandVscode, IconBrandFigma, IconBrandUbuntu } from "@tabler/icons-react"
        ...
        <div className={styles.individualContainer}>
            ...
            <div id={styles.toolsToLearn}>
                ...
                <div id={styles.logoContainer}>
                    <div className={styles.logoName}><IconBrandSlack className={styles.logo}/>Slack</div>
                    <div className={styles.logoName}><IconBrandTrello className={styles.logo}/>Trello</div>
                    <div className={styles.logoName}><IconBrandVscode className={styles.logo}/>VsCode</div>
                    <div className={styles.logoName}><IconBrandFigma className={styles.logo}/>Figma</div>
                    <div className={styles.logoName}><IconBrandUbuntu className={styles.logo}/>Ubuntu</div>
                </div>
            </div>
        </section>
    )
