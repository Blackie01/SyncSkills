...
const faqData = [
  ...
  },
  {
    id: 3,
    question:
      "What other benefits do I stand to gain by enrolling with your organization?",
    answer:
  ...
  },
  {
    ...
    answer: "Yes, we offer installments as a flexible payment option",
  },
  {
    id: 5,
  ...
  },
  {
    id: 8,
    question:
      "Are there any opportunities for practical, hands-on experience or internships?",
    answer:
        ...
        <div className={styles.container}>
          <div className={styles.row}>
            <div className={`${styles.colMd6} ${styles.offsetMd3}`}>
              <div
                className={`${styles.faqTitle} ${styles.textCenter} ${styles.pb3}`}
              >
                <h2>FAQ</h2>
              </div>
            </div>
            <div className={`${styles.colMd6} ${styles.offsetMd3}`}>
              <div
                className={`${styles.faq} ${styles.accordion}`}
                id="accordion"
              >
                  ...
                  <div className={styles.card} key={index}>
                    <div
                      className={`${styles.cardHeader} ${
                        activeId === item.id ? styles.show : ""
                      }`}
                      onClick={() => handleCollapseToggle(item.id)}
                    >
                      <div className={styles.mb0}>
                        <p className={styles.faqTitle}>{item.question}</p>
                      </div>
                    </div>
                    <div
